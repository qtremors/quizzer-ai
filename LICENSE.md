...
- Include a link to the original repository: `https://github.com/qtremors/quizzer-ai`
...
```
Based on Quizzer AI by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/quizzer-ai
```
